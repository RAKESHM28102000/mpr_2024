...
const WorkerCard = ({ imgURL, customerName, rating, feedback }) => {
  return (
    <div className='min-w-[300px] min-h-[380px] bg-white ring-2 ring-transparent hover:ring-white shadow-2xl hover:shadow-pink-700 rounded-md px-2 py-2 shadow-black flex justify-center items-center flex-col'>
      <img
        src={imgURL}
        alt='customer'
