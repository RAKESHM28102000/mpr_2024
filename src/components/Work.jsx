...
const Work = () => {
  return (
    ...
    <h2 className="text-[#3C3633] max-xl:text-[20px] xl:text-4xl text-center font-bold m-4 p-4 hover:text-[#365486] hover:bg-[#E0CCBE] rounded-md shadow-lg shadow-[#C7B7A3] bg-[#E0CCBE]">OUR WORK</h2>
